 ...
 * 1. Rename each function and instance of "oilfield" to match
 ...
 */
function oilfield_preprocess_html(&$vars) {
  // Load the media queries styles
  // Remember to rename these files to match the names used here - they are
  // in the CSS directory of your subtheme.
  $media_queries_css = array(
    'oilfield.responsive.style.css',
    'oilfield.responsive.gpanels.css'
  );
  load_subtheme_media_queries($media_queries_css, 'oilfield');
  ...
  */
  ...
  load_subtheme_ie_styles($ie_files, 'oilfield');
  // */
}

/* -- Delete this line if you want to use this function
function oilfield_process_html(&$vars) {
}
// */
...
function oilfield_preprocess_page(&$vars) {
}

function oilfield_process_page(&$vars) {
}
// */
 ...
 */
/* -- Delete this line if you want to use these functions
function oilfield_preprocess_node(&$vars) {
}

function oilfield_process_node(&$vars) {
}
// */
 ...
 */
/* -- Delete this line if you want to use these functions
function oilfield_preprocess_comment(&$vars) {
}

function oilfield_process_comment(&$vars) {
}
// */
 ...
 */
/* -- Delete this line if you want to use these functions
function oilfield_preprocess_block(&$vars) {
}

function oilfield_process_block(&$vars) {
}
// */
